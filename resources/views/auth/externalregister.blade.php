    ...
    <div class="container " style="margin-top:150px ">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('external.register.post') }}">
                            @csrf
                            <h2 class=" section-title-1 text-center">
                                {!! __('words.plugin_reg_title') !!}
                            </h2>
                            <p class="text-center">
                                {!! __('words.plugon_reg_sec_pera') !!}
                            </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <x-form.input type="text" name="title"
                                        label="{{ __('words.user_title') }}" :value="old('title')" />
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label
                                            for="passwordConfirmationField">{{ __('words.forgot_pass') }}</label>
