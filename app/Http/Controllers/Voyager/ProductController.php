...
use App\Models\Category as Prodcat;
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $dataTypeContent = call_user_func([$query->where('parent_id', null), $getter]);
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Prodcat::where('parent_id',null)->get();
        
        $product_attributes = Attribute::where('product_id',$id)->get();
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','categories','product_attributes'));
    }
    ...
    public function deleteBreadImages($data, $rows, $single_image = null)
    {
        ...
        foreach ($rows as $row) {
            if ($row->type == 'multiple_images') {
                if(!is_array($data->getOriginal($row->field))){
