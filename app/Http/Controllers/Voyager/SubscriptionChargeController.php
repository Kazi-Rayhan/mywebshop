...
class SubscriptionChargeController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            ...
            $datas = (new Clearhaus)->get_transaction($dataTypeContent->quickpay_order_id);
            ...
            return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'datas', 'transiction'));
        } catch (Exception $e) {
            return redirect()->back()->with([
                'message'    => 'Nothing found on clearhaus',
                'alert-type' => 'error',
            ]);
        } catch (Error $e) {
            return redirect()->back()->with([
