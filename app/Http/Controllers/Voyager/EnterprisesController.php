...
class EnterprisesController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        try {
            ...
            $data = Http::post($dataTypeContent->domain . 'api/info', ['secret' => 'password'])->body();
          
            $data = (array) json_decode($data);
            return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'data'));
