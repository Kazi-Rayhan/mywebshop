...
class ShopController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('meta'))  $data->createMetas($request->meta);
    ...
    public function create(Request $request)
    {
        ...
        return view('vendor.voyager.shops.add', compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate(
            [
                ...
                'user_name' => ['required', 'string', 'max:255', 'alpha_num', 'unique:App\Models\Shop,user_name'],
        ...
        // $fee = Iziibuy::needToCharge($enterprise->subscriptionFee() * 1.25);
    ...
    public function send_shop_password(ModelsShop $shop)
    {
    ...
    public function advance_shop_edit( Shop $shop) {
